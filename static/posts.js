const PostsGetter = () => {
    ...
    fetch("./get-posts-data")
        ...
        .then((data) => {
            ...
            // Инициализируем post_PAGE пустой строкой. Это КРИТИЧНО!
            let post_PAGE = '';

            // Используем for...of для итерации по элементам массива 'posts'
            // или forEach, что часто предпочтительнее для массивов
            data.forEach(post => { // Переименовал 'i' в 'post' для лучшей читаемости
